<p align="center">
  <img src="https://github.com/BerndHagen/MetaEdit-Plus-Smart-Tag-Editor/raw/main/img/v1.1.4-metaedit.png" alt="MetaEdit Plus Logo" width="128" />
</p>
...
- **Copy/Paste Metadata:** Copy metadata from one file and paste it to another in Per-File Mode via right-click context menu.
- **Settings Dialog:** Configure ID3v2 version (2.3/2.4), text encoding (UTF-8/UTF-16/Latin1), and tag retention options.
...
- **Context Menus:** Quick access to copy, paste, clear console, select/remove images, copy/paste metadata, and open folder locations.
...
**Copy/Paste Metadata:** In Per-File Mode, right-click on the file list to access:
...
This allows you to quickly duplicate metadata between files while still making individual adjustments.
...
- Automatically resizes images larger than 500px to reduce file sizes
- Applies JPEG compression at 85% quality for optimal size/quality balance
...
<table>
  ...
  <tr>
    <td><a href="https://github.com/BerndHagen/MetaEdit-Plus-Smart-Tag-Editor/raw/main/img/v1.1.4-metaedit_startup.png"><img src="https://github.com/BerndHagen/MetaEdit-Plus-Smart-Tag-Editor/raw/main/img/v1.1.4-metaedit_startup.png" alt="Initial View" width="300"></a></td>
    <td><a href="https://github.com/BerndHagen/MetaEdit-Plus-Smart-Tag-Editor/raw/main/img/v1.1.4-metaedit_inputs.png"><img src="https://github.com/BerndHagen/MetaEdit-Plus-Smart-Tag-Editor/raw/main/img/v1.1.4-metaedit_inputs.png" alt="Directory Scan" width="300"></a></td>
    <td><a href="https://github.com/BerndHagen/MetaEdit-Plus-Smart-Tag-Editor/raw/main/img/v1.1.4-metaedit_generate.png"><img src="https://github.com/BerndHagen/MetaEdit-Plus-Smart-Tag-Editor/raw/main/img/v1.1.4-metaedit_generate.png" alt="Tag Generation" width="300"></a></td>
  </tr>
</table>
